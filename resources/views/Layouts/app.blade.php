            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="{{ route('admin.shipping_zones.index') }}"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Shipping Zones</span>
                    </a>
                </li>
                <li>
                    <a href="#"
                ...
                <li>
                    <a href="{{ route('admin.settings.index') }}"
                        ...
                        <svg class="shrink-0 w-5 h-5 transition duration-75 group-hover:text-fg-brand"
                            ...
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="2"
                                d="M10.335 5h3.33m-3.33 14h3.33m-4.318-2.091L7.5 14.5m10.084-5.591L16.5 9.5l-1.041.601" />
                        </svg>
                        <span class="flex-1 ms-3 whitespace-nowrap">System Settings</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('admin.sliders.index') }}"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Hero Sliders</span>
                    </a>
                </li>
            </ul>
        </div>
